    ...
    <template>
        <div class="col-lg-6 col-md-3 col-sm-11 order-lg-1 order-md-1 order-sm-2 my-sm-2 d-flex align-items-center pt-2">
        ...
        <button @click="newSearch(searchBar)" class=" px-3 py-2"> 
