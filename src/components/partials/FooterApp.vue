    ...
    <div class="bg-footer">
        <div class="container">
            <div class="column">
                ...
                <ul>
                    <a href=""><li>Investitori</li></a>
                    <a href=""><li>Chi siamo</li></a>
                    <a href=""><li>Ristoranti</li></a>
                    <a href=""><li>Altro</li></a>
                    <a href=""><li>Pressroom</li></a>
                    <a href=""><li>Programmazione</li></a>
                    <a href=""><li>Design</li></a>
                    <a href=""><li>Lavora con noi</li></a>
                    <a href=""><li>Diventa nostro patner</li></a> 
                </ul>
            </div>
            <div class="column">
                <h5>Note Legali</h5>
            ...
            <div class="column">
                ...
                <a class="link" href=""><div class="connection d-flex align-items-center mb-3">
                        <div>
                        ...
                        <div class="description">
                            <span>Scaricala su</span>
                            <h4 class="m-0">App Store</h4>
                        </div>
                    </div></a>
                    <a class="link" href=""><div class="connection d-flex align-items-center">
                        <div>
